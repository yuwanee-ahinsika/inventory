    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2 text-sm text-gray-500">
                ...
                <span>/</span>
                <span class="font-semibold text-gray-800">Create</span>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                <div class="p-8">
                    <div class="mb-8">
                        <h3 class="text-xl font-bold text-gray-900">Item Specifications</h3>
                        <p class="text-sm text-gray-500">Enter the details of the new inventory item below.</p>
                    </div>
                    ...
                    <form action="{{ route('stocks.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                   ...
                                   placeholder="e.g. Laser Printer Paper A4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="quantity" class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Initial Quantity *</label>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                      class="block w-full px-4 py-3 rounded-xl border-gray-200 bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all sm:text-sm"
                                      placeholder="Provide additional details about this item...">{{ old('description') }}</textarea>
